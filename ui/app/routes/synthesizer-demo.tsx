...
export default function SynthesizerDemo() {
  ...
  const [polyMode, setPolyModeState] = useState<"poly" | "mono" | "legato">(
    "poly",
  );
      ...
      <div className="max-w-7xl mx-auto pb-8">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold mb-2">
              🎛️ MyMusic DAW - Synthesizer Demo
            </h1>
            <p className="text-gray-400">
              Complete Tauri bridge test with real-time audio events
            </p>
          </div>
          <a
            href="/"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div
              className={`text-2xl font-bold ${isClipping() ? "text-red-500" : "text-green-400"}`}
            >
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {(["sine", "square", "saw", "triangle"] as const).map(
                      (w) => (
                        <button
                          key={w}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={lfo.rate}
                    onChange={(e) =>
                      handleLfoChange("rate", parseFloat(e.target.value))
                    }
                    className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={lfo.depth}
                    onChange={(e) =>
                      handleLfoChange("depth", parseFloat(e.target.value))
                    }
                    className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer"
                  />
                </div>
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {(
                      ["lowpass", "highpass", "bandpass", "notch"] as const
                    ).map((type) => (
                      <button
                        key={type}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={filter.cutoff}
                    onChange={(e) =>
                      handleFilterChange("cutoff", parseFloat(e.target.value))
                    }
                    className="w-full h-2 bg-gray-700 rounded-lg appearance-none cursor-pointer"
                  />
                </div>
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-8">
          <h3 className="text-lg font-semibold mb-4">
            Virtual Piano (use computer keyboard)
          </h3>
        ...
        <div className="bg-gray-800 rounded-lg p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div>
              ...
              <span
                className={`ml-2 ${isEngineReady ? "text-green-400" : "text-red-400"}`}
              >
