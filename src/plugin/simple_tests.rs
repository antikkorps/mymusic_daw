...
mod plugin_tests {
    ...
    fn test_plugin_descriptor_creation() {
        ...
        let descriptor = PluginDescriptor::new("test-plugin", "Test Plugin")
            .with_version("1.0.0")
    ...
    fn test_audio_port_info() {
        ...
        assert_eq!(input_port.port_type, PortType::Input);
    ...
    fn test_plugin_factory_features() {
        let descriptor = PluginDescriptor::new("test", "Test")
    ...
    #[test]
    fn test_plugin_id() {
        let id1 = PluginInstanceId::new();
        let id2 = PluginInstanceId::new();
